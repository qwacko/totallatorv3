...
describe('Bill Filter To Text', async () => {
	...
	it('Filter Returns Useful Text', async () => {
		...
		expect(returnValue).toHaveProperty('1', 'Status equals active');
		expect(returnValue).toHaveProperty('2', 'Can Be Updated');
		expect(returnValue).toHaveProperty('3', 'Max Journal Count of 10');
	});
