...
export const createJournalSchemaCore = z.object({
	...createJournalDBCore.shape,
...
export const createSimpleTransactionSchemaCore = z.object({
	...createJournalSchemaCore.omit({ accountId: true, accountTitle: true }).shape,
...
export const createCombinedTransactionSchema = z
	...
	.refine(
		(data) => {
			const amountTotal = data.reduce((acc, curr) => acc + (curr.amount as number), 0);
...
export const updateJournalSchema = z.object({
	...
	tagId: zodStringBlanking,
	tagTitle: zodStringBlanking,
	tagClear: booleanishSchema.optional().default(false),
	billId: zodStringBlanking,
	billTitle: zodStringBlanking,
	billClear: booleanishSchema.optional().default(false),
	budgetId: zodStringBlanking,
	budgetTitle: zodStringBlanking,
	budgetClear: booleanishSchema.optional().default(false),
	categoryId: zodStringBlanking,
	categoryTitle: zodStringBlanking,
	categoryClear: booleanishSchema.optional().default(false),
	accountId: zodStringBlanking,
	accountTitle: zodStringBlanking,
	...
	clearLabels: booleanishSchema.optional().default(false),
...
export const journalFilterSchema = z.object({
	...journalFilterSchemaWithoutPagination.shape,
