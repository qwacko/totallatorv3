...
DROP MATERIALIZED VIEW "public"."import_check_materialized_view";--> statement-breakpoint
...
CREATE MATERIALIZED VIEW "public"."import_check_materialized_view" AS (select "id", "created_at", "relation_id", "relation_2_id", "description" from "import_check_view");
