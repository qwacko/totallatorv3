...
export type OptionsDataFormatter = (
  value:
    ...
    | number
    | Date
    | (null | undefined | string | number | Date)[],
  dataIndex: number,
) => string;
...
export function chartable(element: HTMLElement, echartOptions: ChartOptions) {
  ...
  let mouseOverHandler: EChartsClickHandler | undefined =
    echartOptions.onMouseOver;
  let mouseOutHandler: EChartsClickHandler | undefined =
    echartOptions.onMouseOut;
  let brushSelectedHandler: EChartsBrushSelectedHandler | undefined =
    echartOptions.onBrushSelected;
  let brushEndHandler: EChartsBrushEndHandler | undefined =
    echartOptions.onBrushEnd;
