<script lang="ts">
  ...
  import type { TagDropdownType } from "@totallator/business-logic";
  import type { TagFilterSchemaType } from "@totallator/shared";
  ...
  let { filter = $bindable() }: { filter: TagFilterSchemaType | undefined } =
    $props();
