...
import { getCurrentWordAtCursor, replaceWordAtCursor } from '$lib/helpers/textReplacement';





type PassthroughProps = Pick<InputProps<string>, 'type' | 'value' | 'placeholder' | 'class'>;
	...
	function generateSuggestions(inputValue: string | undefined, cursorPosition: number): Suggestion[] {
