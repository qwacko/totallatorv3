...
import { reusableFilterCreationURLParams, reusableFilterFilterSchema } from '@totallator/shared';
...
import { cronExecutionFilterSchema, cronJobUrlFilterSchema } from '@totallator/shared';
import { groupedQueryLogFilter, queryLogFilterSchema } from '@totallator/shared';
...
export const skConfigOld = {
	...
	// ----------------------------------------
	'/(loggedIn)/associated': {
		searchParamsValidation: associatedInfoFilterSchemaWithPagination.optional().catch({})
	},
