...
export const getServerEnv = () =>
	serverEnvSchema.parse({
		...
		LOG_DATABASE_ADDRESS: env.LOG_DATABASE_ADDRESS,
		LOG_DATABASE_KEY: env.LOG_DATABASE_KEY,
		LOG_DATABASE_MAX_ENTRIES: env.LOG_DATABASE_MAX_ENTRIES,
		LOG_DATABASE_MAX_AGE_DAYS: env.LOG_DATABASE_MAX_AGE_DAYS,
		REDIS_HOST: env.REDIS_HOST,
		REDIS_PORT: env.REDIS_PORT,
		REDIS_PASSWORD: env.REDIS_PASSWORD,
		REDIS_DB: env.REDIS_DB,
		ENABLE_GLOBAL_WRITE_LOCK: env.ENABLE_GLOBAL_WRITE_LOCK,
		LONG_PROCESS_LOCK_TTL_SECONDS: env.LONG_PROCESS_LOCK_TTL_SECONDS,
		// OpenTelemetry Configuration
		OTEL_ENABLE_TRACING: env.OTEL_ENABLE_TRACING,
		OTEL_SERVICE_NAME: env.OTEL_SERVICE_NAME,
		OTEL_SERVICE_VERSION: env.OTEL_SERVICE_VERSION,
		OTEL_EXPORTER_OTLP_ENDPOINT: env.OTEL_EXPORTER_OTLP_ENDPOINT,
		// Loki Configuration
		LOKI_ENABLE: env.LOKI_ENABLE,
		LOKI_ENDPOINT: env.LOKI_ENDPOINT,
		LOKI_BATCH_SIZE: env.LOKI_BATCH_SIZE,
		LOKI_FLUSH_INTERVAL: env.LOKI_FLUSH_INTERVAL
	});
