...
export type ServerRouteTypeMap = {
	...
	'/(loggedIn)/admin/cron/executions': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig6.searchParamsValidation>;
	};
	'/(loggedIn)/associated': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig7.searchParamsValidation>;
	};
	'/(loggedIn)/autoImport': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig8.searchParamsValidation>;
	};
	'/(loggedIn)/autoImport/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig9.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/autoImport/[id]/[filename]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig10.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/autoImport/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig11.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/backup': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig12.searchParamsValidation>;
	};
	'/(loggedIn)/backup/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig13.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/backup/download/[filename]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig14.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/bills': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig15.searchParamsValidation>;
	};
	'/(loggedIn)/bills/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig16.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/bills/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig17.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/bills/download': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig18.searchParamsValidation>;
	};
	'/(loggedIn)/budgets': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig19.searchParamsValidation>;
	};
	'/(loggedIn)/budgets/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig20.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/budgets/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig21.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/budgets/download': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig22.searchParamsValidation>;
	};
	'/(loggedIn)/categories': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig23.searchParamsValidation>;
	};
	'/(loggedIn)/categories/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig24.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/categories/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig25.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/categories/download': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig26.searchParamsValidation>;
	};
	'/(loggedIn)/files': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig27.searchParamsValidation>;
	};
	'/(loggedIn)/files/linkUnlinked': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig28.searchParamsValidation>;
	};
	'/(loggedIn)/filters': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig29.searchParamsValidation>;
	};
	'/(loggedIn)/filters/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig30.paramsValidation>;
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig30.searchParamsValidation>;
	};
	'/(loggedIn)/filters/[id]/apply': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig31.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/filters/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig32.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/filters/create': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig33.searchParamsValidation>;
	};
	'/(loggedIn)/import': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig34.searchParamsValidation>;
	};
	'/(loggedIn)/import/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig35.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/import/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig36.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/import/[id]/deleteLinked': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig37.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/import/[id]/forget': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig38.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/importMapping': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig39.searchParamsValidation>;
	};
	'/(loggedIn)/importMapping/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig40.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/importMapping/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig41.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/journals': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig42.searchParamsValidation>;
	};
	'/(loggedIn)/journals/bulkEdit': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig43.searchParamsValidation>;
	};
	'/(loggedIn)/journals/clone': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig44.searchParamsValidation>;
	};
	'/(loggedIn)/journals/create': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig45.searchParamsValidation>;
	};
	'/(loggedIn)/journals/delete': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig46.searchParamsValidation>;
	};
	'/(loggedIn)/journals/download': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig47.searchParamsValidation>;
	};
	'/(loggedIn)/journals/summaryData': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig48.searchParamsValidation>;
	};
	'/(loggedIn)/labels': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig49.searchParamsValidation>;
	};
	'/(loggedIn)/labels/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig50.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/labels/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig51.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/labels/download': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig52.searchParamsValidation>;
	};
	'/(loggedIn)/llm/logs': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig53.searchParamsValidation>;
	};
	'/(loggedIn)/llm/logs/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig54.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/llm/providers/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig55.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/llm/providers/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig56.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/queries/grouped': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig57.searchParamsValidation>;
	};
	'/(loggedIn)/queries/list': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig58.searchParamsValidation>;
	};
	'/(loggedIn)/reports/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig59.paramsValidation>;
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig59.searchParamsValidation>;
	};
	'/(loggedIn)/reports/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig60.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/tags': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig61.searchParamsValidation>;
	};
	'/(loggedIn)/tags/[id]': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig62.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/tags/[id]/delete': {
		params: StandardSchemaV1.InferOutput<typeof routeConfig63.paramsValidation>;
		searchParams: {};
	};
	'/(loggedIn)/tags/download': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig64.searchParamsValidation>;
	};
	'/(loggedIn)/users': {
		params: {};
		searchParams: StandardSchemaV1.InferOutput<typeof routeConfig65.searchParamsValidation>;
	};
