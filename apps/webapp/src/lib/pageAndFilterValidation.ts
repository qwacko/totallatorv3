...
export const accountPageAndFilterValidation = z.object({
  ...
  prevPage: z
    ...
    .optional()
    .default(
      urlGenerator({ address: "/(loggedIn)/accounts", searchParamsValue: {} })
        .url,
    ),
  currentPage: z
    .string()
...
export const billPageAndFilterValidation = z.object({
  ...
  prevPage: z
    ...
    .optional()
    .default(
      urlGenerator({ address: "/(loggedIn)/bills", searchParamsValue: {} }).url,
    ),
  currentPage: z
    .string()
    .optional()
...
export const budgetPageAndFilterValidation = z.object({
  ...
  prevPage: z
    ...
    .optional()
    .default(
      urlGenerator({ address: "/(loggedIn)/budgets", searchParamsValue: {} })
        .url,
    ),
  currentPage: z
    .string()
...
export const categoryPageAndFilterValidation = z.object({
  ...
  prevPage: z
    ...
    .optional()
    .default(
      urlGenerator({ address: "/(loggedIn)/categories", searchParamsValue: {} })
        .url,
    ),
  currentPage: z
    .string()
...
export const labelPageAndFilterValidation = z.object({
  ...
  prevPage: z
    ...
    .optional()
    .default(
      urlGenerator({ address: "/(loggedIn)/labels", searchParamsValue: {} })
        .url,
    ),
  currentPage: z
    .string()
...
export const tagPageAndFilterValidation = z.object({
  ...
  prevPage: z
    ...
    .optional()
    .default(
      urlGenerator({ address: "/(loggedIn)/tags", searchParamsValue: {} }).url,
    ),
  currentPage: z
    .string()
    .optional()
