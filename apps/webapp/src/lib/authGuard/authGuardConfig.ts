import { type RouteConfig, skGuard } from "skguard";
...
const POSTAllowUsers = (data: UserValidationOutput) =>
  data.user ? undefined : "Not Authorised";
...
export const { backend: authGuard, frontend: authGuardFrontend } = skGuard({
  routeConfig: {
    ...
    "/(open)/params": {
      ...openConfig,
      POSTCheck: { testAction: POSTAllowUsers },
    },
    ...
    "/(loggedIn)/import/create": {
      ...adminOnlyConfig,
      POSTCheck: { create: POSTAllowAdminOnly },
    },
    "/(loggedIn)/import/[id]": {
      ...adminOnlyConfig,
      POSTCheck: {
    ...
    "/(loggedIn)/journals/bulkEdit": {
      ...adminOnlyConfig,
      POSTCheck: {
        updateState: POSTAllowAdminOnly,
        update: POSTAllowAdminOnly,
      },
    },
    ...
    "/(loggedIn)/testFunctions": {
      ...adminOnlyConfig,
      POSTCheck: { default: POSTAllowUsers },
    },
