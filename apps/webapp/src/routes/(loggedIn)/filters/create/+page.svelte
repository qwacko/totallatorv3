<script lang="ts">
  ...
  import { reusableFilterModifcationTypeItems } from "@totallator/shared";
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col items-center gap-6 self-center">
          <Badge color="gray">Filter Can Be Modified After Saving</Badge>
          ...
          <div class="flex flex-col gap-1">
            ...
            <div class="flex text-gray-400">
              {data.numberResults} matching journals
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-row items-center gap-6 self-center">
          <Badge color="gray">Change Can Be Modified After Saving</Badge>
