...
<PageLayout
  title="Delete Import Linked Items"
  subtitle={data.info.importInfo.import.title}
>
  <P>
    Delete items linked to import {data.info.importInfo.import.title}? This will
    leave the import for future reuse.
  </P>
  <Button
    href={urlGenerator({
