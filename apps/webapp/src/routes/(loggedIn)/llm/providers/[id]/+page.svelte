<script lang="ts">
  ...
  let selectedProvider = $state(
    $form.apiUrl || predefinedProviders[0]?.id || "openai",
  );
...
<PageLayout title={data.provider.title} size="sm">
  ...
  <div class="mt-6 flex flex-col gap-2">
    ...
    <Button outline color="blue" href={logsURL}
      >View Logs for this Provider</Button
    >
    <Button outline color="green" href={testConnectionURL}
