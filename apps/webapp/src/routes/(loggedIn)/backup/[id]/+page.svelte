    ...
    <div class="grid grid-cols-2 gap-2">
      ...
      <div class="flex flex-row items-center gap-2">
        {#if editingTitle}
          ...
          <Button onclick={() => (editingTitle = false)} size="sm" outline>
            <CancelIcon />
          </Button>
        {:else}
      ...
      <div class="grid">
        {new Date(data.backupInformation.createdAt).toISOString()}
      </div>
      ...
      <div class="grid">
        {information.information.itemCount.numberJournalEntries}
      </div>
      <div class="grid justify-self-end font-bold">Other Items Count</div>
      <div class="grid">
        <div class=" flex flex-row flex-wrap gap-2">
          <Badge
            >Accounts : {information.information.itemCount
              .numberAccounts}</Badge
          >
          <Badge
            >Categories : {information.information.itemCount
              .numberCategories}</Badge
          >
          ...
          <Badge
            >Budgets: {information.information.itemCount.numberBudgets}</Badge
          >
          <Badge
            >Transactions : {information.information.itemCount
              .numberTransactions}</Badge
          >
          <Badge
            >Journals : {information.information.itemCount
              .numberJournalEntries}</Badge
          >
          <Badge
            >Labels : {information.information.itemCount.numberLabels}</Badge
          >
          <Badge>
            Reusable Filters : {information.information.itemCount
              .numberReusableFilters}
          </Badge>
          <Badge
            >Imports : {information.information.itemCount
              .numberImportTables}</Badge
          >
          <Badge
            >Import Items : {information.information.itemCount
              .numberImportItemDetails}</Badge
          >
          <Badge
            >Import Mappings : {information.information.itemCount
              .numberImportMappings}</Badge
          >
          <Badge
            >Auto Imports : {information.information.itemCount
              .numberAutoImport}</Badge
          >
          <Badge
            >Key Values : {information.information.itemCount
              .numberKeyValues}</Badge
          >
          <Badge
            >Report Elements : {information.information.itemCount
              .numberReportElements}</Badge
          >
          <Badge
            >Report Filters : {information.information.itemCount
              .numberReportFilters}</Badge
          >
          <Badge
            >Report Items : {information.information.itemCount
              .numberReportItems}</Badge
          >
          <Badge
            >Reports : {information.information.itemCount.numberReports}</Badge
          >
          <Badge
            >Backups : {information.information.itemCount.numberBackups}</Badge
          >
