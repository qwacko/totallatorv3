...
export const load = async ({ locals }) => {
	...
	const budgetsWithJournalCount = await tActions.budget.listWithTransactionCount();
	...
	const labelsWithJournalCount = await tActions.label.listWithTransactionCount();
...
export const actions = {
	bulkAddJournals: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0002',
				title: 'Error Creating Bulk Journals',
				error: e
			});
		}
	},
	bulkAddAccounts: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0003',
				title: 'Error Creating Bulk Accounts',
				error: e
			});
		}
	},
	bulkAddTags: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0004',
				title: 'Error Creating Bulk Tags',
				error: e
			});
		}
	},
	bulkAddBills: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0005',
				title: 'Error Creating Bulk Bills',
				error: e
			});
		}
	},
	bulkAddBudgets: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0006',
				title: 'Error Creating Budget Tags',
				error: e
			});
		}
	},
	bulkAddCategories: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0007',
				title: 'Error Creating Bulk Categories',
				error: e
			});
		}
	},
	bulkAddLabels: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0008',
				title: 'Error Creating Bulk Labels',
				error: e
			});
		}
	},
	...
	deleteUnusedJournals: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0010',
				title: 'Error Deleting Unused Journals',
				error: e
			});
		}
	},
	deleteUnusedAccounts: async (data) => {
		try {
			...
			data.locals.global.logger('server').error({
				code: 'DEV_0011',
				title: 'Error Deleting Unused Accounts',
				error: e
			});
		}
	},
	...
	deleteUnusedCategories: async ({ locals }) => {
		try {
			...
			locals.global.logger('server').error({
				code: 'DEV_0013',
				title: 'Error Deleting Unused Categories',
				error: e
			});
		}
	},
	deleteUnusedBills: async ({ locals }) => {
		try {
			...
			locals.global.logger('server').error({
				code: 'DEV_0014',
				title: 'Error Deleting Unused Bills',
				error: e
			});
		}
	},
	deleteUnusedBudgets: async ({ locals }) => {
		try {
			...
			locals.global.logger('server').error({
				code: 'DEV_0015',
				title: 'Error Deleting Unused Budgets',
				error: e
			});
		}
	},
	deleteUnusedLabels: async ({ locals }) => {
		try {
			...
			locals.global.logger('server').error({
				code: 'DEV_0016',
				title: 'Error Deleting Unused Labels',
				error: e
			});
		}
	},
	deleteReusableFilters: async ({ locals }) => {
		try {
			...
			locals.global.logger('server').error({
				code: 'DEV_0017',
				title: 'Error Deleting Reusable Filters',
				error: e
			});
		}
	}
