...
export const load = async ({ locals }) => {
  ...
  const accountsWithJournalCount =
    await tActions.account.listWithTransactionCount(locals.db);
  ...
  const budgetsWithJournalCount =
    await tActions.budget.listWithTransactionCount(locals.db);
  ...
  const categoriesWithJournalCount =
    await tActions.category.listWithTransactionCount(locals.db);
...
export const actions = {
  ...
  deleteUnusedAccounts: async (data) => {
    try {
      const accountsWithJournalCount =
        await tActions.account.listWithTransactionCount(data.locals.db);
  ...
  deleteUnusedBills: async ({ locals }) => {
    try {
      const billsWithJournalCount =
        await tActions.bill.listWithTransactionCount(locals.db);
  ...
  deleteUnusedLabels: async ({ locals }) => {
    try {
      const labelsWithJournalCount =
        await tActions.label.listWithTransactionCount(locals.db);
