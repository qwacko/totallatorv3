...
export const backupRestoreProcessor = async (job, context) => {
    const payload = job.data.data;
    const backupRestoreProgressToPercent = ({ phase, current, total }) => {
    ...
    await runTrackedLongProcess({
        ...
        run: async ({ reportProgress }) => standaloneContext({
            ...
            await tActions.backup.restoreBackup({
                ...
                onProgress: async (update) => {
                    ...
                    const phaseLabel = update.phase === 'retrieving'
...
export const backupStoreProcessor = async (job) => {
    await runTrackedLongProcess({
        type: 'backup-store',
        entityType: 'backup',
        message: 'Backup store',
        run: async () => standaloneContext({
...
export const backupRefreshProcessor = async () => {
    await runTrackedLongProcess({
        type: 'backup-refresh',
        entityType: 'backup',
...
export const backupTrimProcessor = async () => {
    await runTrackedLongProcess({
        type: 'backup-trim',
        entityType: 'backup',
        message: 'Backup trim',
...
export const backupDeleteProcessor = async (job) => {
    await runTrackedLongProcess({
        type: 'backup-delete',
        entityType: 'backup',
...
export const backupImportProcessor = async (job) => {
    const payload = job.data.data;
    await runTrackedLongProcess({
        type: 'backup-import',
        entityType: 'backup',
...
export const autoImportTriggerProcessor = async (job, context) => {
    const payload = job.data.data;
    await runTrackedLongProcess({
        ...
        run: async ({ reportProgress }) => standaloneContext({
            ...
            await tActions.autoImport.trigger({
                ...
                reportProgress: async (update) => {
                    const scaledProgress = update.progress === undefined
                        ? 90
...
export const importStoreProcessor = async (job) => {
    const payload = job.data.data;
    await runTrackedLongProcess({
        type: 'import-store',
        entityType: 'import',
...
export const importReprocessProcessor = async (job) => {
    await runTrackedLongProcess({
...
export const importCleanProcessor = async (job) => {
    await runTrackedLongProcess({
        type: 'import-clean',
        entityType: 'import',
        entityId: job.data.data.importId,
...
export const importTriggerProcessor = async (job) => {
    await runTrackedLongProcess({
        type: 'import-trigger',
        entityType: 'import',
        entityId: job.data.data.importId,
...
export const importDeleteProcessor = async (job) => {
    await runTrackedLongProcess({
        type: 'import-delete',
        entityType: 'import',
        entityId: job.data.data.importId,
...
export const importDeleteLinkedProcessor = async (job) => {
    await runTrackedLongProcess({
...
export const importForgetProcessor = async (job) => {
    await runTrackedLongProcess({
        type: 'import-forget',
        entityType: 'import',
        entityId: job.data.data.importId,
...
export const fileCheckExistsProcessor = async () => {
    await runTrackedLongProcess({
...
workerRegistry.registerTyped('backup-restore', backupRestoreProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('backup-store', backupStoreProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('backup-refresh', backupRefreshProcessor, { attempts: 1 });
workerRegistry.registerTyped('backup-trim', backupTrimProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('backup-delete', backupDeleteProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('backup-import', backupImportProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('auto-import-trigger', autoImportTriggerProcessor, { attempts: 3 });
workerRegistry.registerTyped('import-store', importStoreProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('import-reprocess', importReprocessProcessor, { attempts: 2 });
workerRegistry.registerTyped('import-clean', importCleanProcessor, {
    attempts: 2
});
workerRegistry.registerTyped('import-trigger', importTriggerProcessor, {
    attempts: 2
});
workerRegistry.registerTyped('import-delete', importDeleteProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('import-delete-linked', importDeleteLinkedProcessor, { attempts: 1 });
workerRegistry.registerTyped('import-forget', importForgetProcessor, {
    attempts: 1
});
workerRegistry.registerTyped('file-check-exists', fileCheckExistsProcessor, { attempts: 1 });
