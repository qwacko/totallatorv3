...
export const cronControlProcessor: TypedJobProcessor<WorkerJobMap, 'cron-control'> = async (
	job,
	context
) => {
...
workerRegistry.registerTyped<WorkerJobMap, 'cron-control'>('cron-control', cronControlProcessor, {
	attempts: 1
});
